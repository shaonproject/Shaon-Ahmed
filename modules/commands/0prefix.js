...
━━━━━━━━━━━━━━━━━━
🌸 ===『 𝐌𝐫 𝐍𝐀𝐙𝐑𝐔𝐋 💁😘🪽 』=== 🌸`
        return api.sendMessage({body: msg, attachment: (await axios.get((await axios.get(`https://noobs-api-d7bl.onrender.com/video/status2`)).data.data,  {
                    responseType: 'stream'
                })).data},event.threadID); 
         }
