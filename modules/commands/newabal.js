...
module.exports.run = async function({ api, args, Users, event}) {
  ...
  if(!mention) return api.sendMessage("মাগির পোলা রে   @মেনশন দেন আমি ওর মার ভোদা ফাইরা লামু😾", event.threadID);
let name =  event.mentions[mention];
  var arraytag = [];
      arraytag.push({id: mention, tag: name});
  var a = function (a) { api.sendMessage(a, event.threadID); }
a("খানকির পোলা তোর মারে বাসর রাতে চুদে ভোদা ফাটাইছিলাম আমি তোর আব্বু নজরুল এর চোদা খা 😼");
setTimeout(() => {a({body: "খাংকির পোলা তর মারে চুইদা তোর মার বোদা তে আমার মাল ফালাবো তোর বাপ আমি নজরুল  🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "ওওও বান্দি র পোলা মাগির ছাওয়াল  তোর বাপ আমি নজরুল 😍.." + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "মাদারচোদ তর আম্মু পম পম খায় তোর বাপ নজরুল 🐰" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "এখন ছন্দের তালে তালে তোর মারে চুদবো আাজকে খালে বিলে আমি তোর বাপ নজরুল💔!" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "এই বস্তির পোলা তুই নাকি দেশ নজরুল  রে গালি তোর মারে চো*দে আমার ভাই আলী" + " আমি নজরুল।" + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "depression থেকেও তোর মার ভোদা চুইদা কালা কইরা দিছি আমি তোর বাপ! 🤬 " + " আমি নজরুল তোর বাপ🎯" + name, mentions: arraytag})}, 15000);
setTimeout(() => {a({body: "সেডা বাঙ্গা খানকির পোলা তোর মায়রে আমি নজরুল  চ*** উরাধুর🤬" + " আমি নজরুল।" + name, mentions: arraytag})}, 17000);
setTimeout(() => {a({body: "বান্দির পোলা তর কচি বোনের ভুদা ফাক কর থুতু দিয়ে ভুদায় দন ডুকামু 🤟" + "আমি নজরুল " + name, mentions: arraytag})}, 20000);
setTimeout(() => {a({body: "এই যে কান্দিস না আমার পোলা তোর মায়েরে চুদমু আমি খোলা খোলা আমি তোর আব্বু নজরুল🤝" + " " + name, mentions: arraytag})},23000);
setTimeout(() => {a({body: "উফফফ  মাগির পোলা তোর মার কালা বোদা আমার অনেক পছন্দ💉।" + " " + name, mentions: arraytag})}, 25000);
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখবি আমি নজরুল তোর বাপ😘।" + " " + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "ও বান্দি মাগির পোলা তোর মারে চুইদা তোর মার বোদা করমু গোলা...! ✋" + " " + name, mentions: arraytag})},31000);
setTimeout(() => {a({body: " নজরুল তোর আব্বা তোর মার ভোদাতে ঢুকামু দুইটা ডাব্বা " + "" + name, mentions: arraytag})}, 36000);
...
setTimeout(() => {a({body: "depression থেকেও তর মাইরে চুইদা ফাটামু আমি নজরুল তোর বাপ!🤬 " + " " + name, mentions: arraytag})}, 59400);
...
setTimeout(() => {a("~ 𝙃𝙐𝙎𝙎𝘼𝙄𝙉 এর জারজ শন্তান🤖")} , 93000);
setTimeout(() => {a({body: "Welcome বস নজরুলের এর পোলা I Mean আমার ভাতিজা 🥰।" + " " + name, mentions: arraytag})}, 99000);
setTimeout(() => {a({body: "তর কচি বোন এর পম পম গোলা উফ😍.." + " " + name, mentions: arraytag})}, 105000);
setTimeout(() => {a({body: "ওহে আমার পোলা তুই টেনশন নিস না তোর মায়রে চুইদা তোর মার বোদা করমু ফালা ফালা🩲👙 তোর বাপ নজরুল" + " ।" + name, mentions: arraytag})}, 111000);
...
setTimeout(() => {a({body: "Hi নজরুল এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "আই মুরগি মাদার চোদ কলে  আছে নাকি আমার মামা ,,তোর মায় রে চুইদ্দা ছিরা লাইসি তোর মার জমা,,,🙈🩲 " + "তোর বাপ নজরুল" + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "জামার নিচে আছে নাকি জাইঙ্গা মুরগী মাগীর পোলা তোর ময় রে চুদুম তোর বাপের হাত পাও টি বাইন্দা,,,😘☺️ " + "তোর বাপ নজরুল" + name, mentions: arraytag})}, 15000);
...
setTimeout(() => {a({body: ",মুরগি তুই তোর মার ভোদা টা গিয়া কামরা😆,," + "আমি নজরুল তোর বাপ" + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body:",, কাচ্চি খাইতে লাগে নাকি মজা তোর মায় রে চুইদ্দা খামু আমি 1 কুলকি গাজা,,," + " আমি নজরুল তোর বাপ" + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~,,,আমি নজরুল চুইদ্দা তোর বইনের ভোদা করসি ফাঁকা,,")} , 39000);
...
setTimeout(() => {a({body: "কাচ্চি খাইতে লাগে নাকি মজা তোর মায় রে চুইদ্দা খামু আমি 1 কুলকি গাজা গাঁজা খেয়ে তোর মায়েরে চুইদা তোর মারে gift দিমু খাজা😘,,,.." + "আমি নজরুল তোর আব্বু 😿😈" + name, mentions: arraytag})}, 5000);
...
setTimeout(() => {a({body: ",,সুন মুরগি আমার কলিজা গুলা তোর বইনেরে চুইদ্দা কোয় তোর বইনের ভোদা টা বলে অনেক বাকা,," + "তোর রিয়েল বাপ নজরুল" + name, mentions: arraytag})}, 12000);
...
setTimeout(() => {a({body: "19,,কি রে মাদার চোদ নাম নাকি আমার ❤️রোমান্টিক লুঙ্গি ❤️তোর বইনেরী চুইদ্দা বজায় ভাতিজা আমি তোর বাপ নজরুল 🎯" + " " + name, mentions: arraytag})}, 17000);
...
setTimeout(() => {a({body: "আমার গ্রুপ এর এডমিন নাকি❤️ CID ❤️  তোর মায় রে চুইদ্দা তোর বইন রেও চ*** ,,,," + "আমি  নজরুল তোর বাপ😛" + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~খানকির পোলা ও মাগির পোলা তোর বাপ আমি নজরুল যেইখানে দেখবি ১০০ বার সালাম দিবি নাইলে তোর মার বোদা থাপ্পর দিয়া ও মাগির পোলা তোর মারে ডগ স্টাইলে চ**** চোদানি মাগির পোলা আম গাছে আম পোলাপাইন তোর মার দুধ দেখলে করে খালি খাম খাম,,,!😈😛")} , 39000);
