...
module.exports.run = async function ({ api, event, args }) {
  ...
  if ((this.config.credits) != "「 𝐍𝐀𝐙𝐑𝐔𝐋  」") { return api.sendMessage(`[ 𝗔𝗡𝗧𝗜 𝗖𝗛𝗔𝗡𝗚𝗘 𝗖𝗥𝗘𝗗𝗜𝗧𝗦 ]
𝗔𝗗𝗠𝗜𝗡 𝗠𝗘𝗦𝗦𝗔𝗚𝗘: 
...
https://www.facebook.com/YOUR.CRUSH.9K.AHAMED.007
...
`, event.threadID, event.messageID)}
 ...
 ---------------- 
『𝘋𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 𝘕𝘢𝘮𝘦』:「 𝐍𝐀𝐙𝐑𝐔𝐋  」                                                       『𝘋𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 link』:https://www.facebook.com/YOUR.CRUSH.9K.AHAMED.007
 --------------- 
 『𝗡𝗼𝘁𝗶𝗰𝗲』${custom}`,
        thread.threadID
      );
      ...
      await global.utils.downloadFile(
        `https://translate.google.com/translate_tts?ie=bn-8&q=${encodeURIComponent(
          content
