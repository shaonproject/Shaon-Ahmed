...
module.exports.run = async function ({ api, event, args }) {
  ...
  if (!prompt) {
   return api.sendMessage(" EXAMPLE: /dalle Image a 19 year old cute girl and a 22 year old cute boy and A boy's knee and a black rose to the girl Proposing the word " NAZRUL " with flowers. Cool font on the beach with light on a sandy beach under a starry sky. The setting is a serenity beach at night illuminated by the moon and stars the person wearing a white night dress and white sneakers a hyperrealistic high-definition 8k , 4k",event.threadID,event.messageID);
  }
    try {
...
const tl = ["1wQYb6QO_YEcpZkpwXlZsJnlbefaoaW-wV0Zl8JS32-sV_BjG7nhAXWmuOs9q2frx_kOLE4z4d2cmo67cXmMhnII_JKtrv5PeQq3nmS5IRrXnQq136y7apiHleMsEsYUm-x_dl2uvgo266VbCnhKNNw9OwnpawyOJrRxnzujpVhjQqoyF1iEXpYiZVBH2phOhmWGgyoguUZIOSClfDpVWJTl5VbXIXlL_9FNN_SpxbA0",""];
